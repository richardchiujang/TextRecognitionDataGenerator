...
from utils import mask_to_bboxes, make_filename_valid
    ...
    def generate(
        ...
        if orientation == 0:
            ...
            resized_img = distorted_img.resize(
                (new_width, size - vertical_margin), Image.LANCZOS # Image.Resampling.LANCZOS
            )
            resized_mask = distorted_mask.resize(
                (new_width, size - vertical_margin), Image.NEAREST # Image.Resampling.NEAREST
            )
        ...
        # Vertical text
            ...
            resized_img = distorted_img.resize(
                (size - horizontal_margin, new_height), Image.LANCZOS # Image.Resampling.LANCZOS
            )
            resized_mask = distorted_mask.resize(
                (size - horizontal_margin, new_height), Image.NEAREST # Image.Resampling.NEAREST
            )
